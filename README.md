...
This project was created for **GMTK Game Jam 2025** with the theme **LOOP**, focusing on innovative gameplay mechanics within the constraints of a short development timeline. This game explores themes of:
...
- **Real-time problem solving** with moving constraints
...
**Team BOOM** - Game design and implementation

- Nova (TheRealNovelist) - Development & Programming
- DLCrimson - Development & Programming
- Tuna (tuanades) - Visuals & Art
- Ganderahaha - Project Management
...
SFX: Pixabay
Music: Zakiro - Free Casual Game Music Pack
Font: Norwester by Jamie Wilson
Building System Assets: Sunny Valley Studio

## 📄 License

This project is licensed under the Apache License, Version 2.0 - see the LICENSE file for details.
Created for GMTK Game Jam 2025. Third-party assets retain their original licenses as credited above.

---

_Built with ❤️ by the BOOM team for GMTK Game Jam 2025_
